...
import { RedirectLoginOptions, User } from '@authok/authok-spa-js';
import useAuthok from './use-authok';
...
const withAuthenticationRequired = <P extends object>(
  ...
  return function WithAuthenticationRequired(props: P): JSX.Element {
    const { user, isAuthenticated, isLoading, loginWithRedirect } = useAuthok();
    const {
